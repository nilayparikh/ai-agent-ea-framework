...
The LocalM™ AiD Framework is provided under the **Mozilla Public License 2.0 (MPL 2.0)**.
...
<div class="page-meta-table">
  ...
  <div class="page-meta-item">
    ...
    <span class="page-meta-value">AI-Assisted Development Governance</span>
  </div>
  <div class="page-meta-item">
    <span class="page-meta-label">COPYRIGHT</span>
    <span class="page-meta-value">© 2025 Nilay Parikh</span>
  </div>
</div>
...
>
> The LocalM™ AiD Framework provides **Enterprise Architecture Principles for AI Coding Agent Operations** and **AI-Assisted Software Development Governance**. It is intended as guidance only and should be adapted to your organization's specific needs.
...
No Contributor makes additional grants as a result of Your choice to distribute the Covered Software under a subsequent version of this License or under the terms of a Secondary License.
...
You may not remove or alter the substance of any license notices contained within the Source Code Form.
...
**5.2.** If You initiate litigation against any entity asserting that a Covered Software infringes any patent, then your rights under this License terminate.
...
> **UNDER NO CIRCUMSTANCES AND UNDER NO LEGAL THEORY, WHETHER TORT (INCLUDING NEGLIGENCE), CONTRACT, OR OTHERWISE, SHALL ANY CONTRIBUTOR BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES.**

---

## Contact

For questions about licensing or enterprise arrangements:

- **Website**: <a href="https://localm.ai" target="_blank" rel="noopener">localm.ai</a>
- **Framework**: <a href="https://localm.ai/framework" target="_blank" rel="noopener">localm.ai/framework</a>
- **Author**: Nilay Parikh (<a href="https://linkedin.com/in/niparikh" target="_blank" rel="noopener">LinkedIn</a>)

---

## Related

- [About LocalM™ AiD](about) - Framework overview
- [How to Contribute](contributing) - Contribution guidelines
- [All Principles](principles/) - Browse the framework principles
